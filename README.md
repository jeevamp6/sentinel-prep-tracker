...
*   **⚡ 3-Tier Authentication System:** 
    ...
    *   **Admin Command Center:** Hidden login portal (`/admin-login.html`) utilizing a custom ID Card (e.g., `89SC78`) and a secret passphrase to bypass standard authentication.
...
2. Log into the Sentinel **Command Center** using your Admin ID Card (`89SC78`) and Secret Passphrase (`OVERRIDE_007`) at `/admin-login.html`.
